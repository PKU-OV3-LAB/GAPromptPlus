...
def get_args():
    ...
    parser.add_argument(
        ...
        help = 'vote acc')
    parser.add_argument(
        '--vote_runs', type=int, default=99,
        help='number of voting evaluations')
    parser.add_argument(
        '--vote_times', type=int, default=10,
        help='augmentations per voting evaluation')
    parser.add_argument(
        '--resume',
        action='store_true',
        default=False,
        help = 'auto resume training (interrupted by accident)')
    parser.add_argument(
        '--test',
        action='store_true',
        default=False,
    ...
    args.experiment_path = os.path.join('./experiments', Path(args.config).stem, Path(args.config).parent.stem, args.exp_name, timestamp)
