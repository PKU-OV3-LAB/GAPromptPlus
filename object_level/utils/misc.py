...
def peft_detect(name:str, targets:list):
...
def summary_parameters(model, logger=None, detail=True):
    ...
    print_log('>> {:25s}\t{:.2f}\tM  {:.2f}\tK'.format('# TrainableParams:', num_trainable_params / (1.0 * 10 ** 6), num_trainable_params / (1.0 * 10 ** 3)), logger)
