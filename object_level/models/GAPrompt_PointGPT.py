...
class PointNetSetAbstraction(nn.Module):
    def __init__(self, num_group, group_size, in_channel, mlp):
        ...
        self.group_divider = Group2(num_group, group_size)
        self.num_group = num_group
        self.group_size = group_size
...
class ShiftNet(nn.Module):
    def __init__(self, in_channels, out_channels, hidden_dimesion=384, perturbation=0.01, embedding_level=4, num_group = 128, group_size = 32, top_center_dim=8):
        super().__init__()
