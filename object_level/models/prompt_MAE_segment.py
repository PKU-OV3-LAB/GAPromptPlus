...
class PointTransformer_pointtokenprompt_seg(nn.Module):
    def __init__(self, config, **kwargs):
        ...
        self.prompt_embeddings = nn.Parameter(torch.zeros(21, self.trans_dim))
    ...
    def forward(self, pts, cls_label, contrast=False, target=None):
        ...
        feature_list, prompt_list = self.blocks(x, pos, global_feature=shape_feature, token_position=token_pos)
