...
class PointPromptTraining(nn.Module):
    ...
    def __init__(
        ...
        valid_index=(
            # class idx (in `class_name`) of each datasets (in `conditions`)
        ...
        # - dataset-specific context embedding - the domain prompts
    ...
    def forward(self, data_dict):
        ...
        sim = (
            ...
            @ self.class_embedding[
                # class eembeddings of current dataset
